...
function min_data(){//하위 5개 data
    let minvalue = [];
    let endList = [];
    //let rankingNum=0;
    //let min = 1000000;
    //while(minvalue.length != 2){
    ...
    while(endList.length <= 2){
        ...
        let min=10000;
        let minlocation = "";
        let idNum=market.length-endList.length;
        let rankingNum=market.length-endList.length;
